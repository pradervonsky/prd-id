...
A: Dicatat sesuai tanggal dokumen sumber (kuitansi/bukti transaksi asli). Perekaman backdate diperbolehkan selama periode buku terkait belum tutup buku.
...
A: Pada periode chat ini statusnya masih kendala di beberapa satker dan sedang diteruskan ke SITP — belum ada solusi permanen yang dapat diberikan.
...
*Sumber: Chat WhatsApp grup `SAKTI BLU Familiarisasi` 15 Juni s.d. 22 September 2026 (diolah).*
